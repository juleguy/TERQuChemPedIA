...
\chapter{Prédiction de géométries moléculaires convergées}
	\section{Motivation et méthodologie}
		\input{6-Prediction_de_geometries_moleculaires_convergees/motivation.tex}
		
	 \section{Données}
		\input{6-Prediction_de_geometries_moleculaires_convergees/donnees.tex}

	\section{Évaluation des performances}
		\input{6-Prediction_de_geometries_moleculaires_convergees/evaluation.tex}
		
	\section{Architectures}
		\input{6-Prediction_de_geometries_moleculaires_convergees/architectures.tex}
		
	\section{Optimisation des modèles}
		\input{6-Prediction_de_geometries_moleculaires_convergees/optimisation.tex}
		
	\section{Performances}
		\input{6-Prediction_de_geometries_moleculaires_convergees/performances.tex}
...
\begin{minipage}{3.3cm}\vspace{1cm}DELTA\_DIST+H\_05 \vspace{5mm} \end{minipage} &
